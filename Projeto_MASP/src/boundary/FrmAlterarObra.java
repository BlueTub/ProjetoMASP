...
public class FrmAlterarObra extends JFrameCustom{
	...
	private JButtonCustom btnExcluir;
	...
	public FrmAlterarObra(){
		...
		btnExcluir = new JButtonCustom("Excluir");
		painelBotoes.add(btnExcluir);
		btnExcluir.setBounds(600, 10, 130, 35);
		...
		ActionListener al = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (cmd.equals(btnExcluir.getText())){
					Obra obra = new Obra();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmAlterarObra tela = new FrmAlterarObra();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
